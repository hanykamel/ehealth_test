...
{
    public class UpdateServicesUHIAPricesCommandValidator : AbstractValidator<UpdateServicesUHIAPricesCommand>
    {
        private readonly IServiceUHIARepository _serviceUHIARepository;
        private bool _validserviceUHIA = false;
        public UpdateServicesUHIAPricesCommandValidator(IServiceUHIARepository serviceUHIARepository)
        {
