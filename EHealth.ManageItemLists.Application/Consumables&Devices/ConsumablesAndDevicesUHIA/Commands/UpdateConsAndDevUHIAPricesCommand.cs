...
{
    public class UpdateConsAndDevUHIAPricesCommand : UpdateConsAndDevUHIAPriceDto, IRequest<bool>, IValidationModel<UpdateConsAndDevUHIAPricesCommand>
    {
        private readonly IConsumablesAndDevicesUHIARepository _consumablesAndDevicesUHIARepository;
        public UpdateConsAndDevUHIAPricesCommand(UpdateConsAndDevUHIAPriceDto request, IConsumablesAndDevicesUHIARepository consumablesAndDevicesUHIARepository)
        {
            ConsAndDevUHIAId = request.ConsAndDevUHIAId;
            ItemListPrices = request.ItemListPrices;
            _consumablesAndDevicesUHIARepository = consumablesAndDevicesUHIARepository;
        }
        public AbstractValidator<UpdateConsAndDevUHIAPricesCommand> Validator => new UpdateConsAndDevUHIAPricesCommandValidator(_consumablesAndDevicesUHIARepository);
    }
}