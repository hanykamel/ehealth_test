...
{
    public class CreateDrugUHIABasicDataDto
    {
        ...
        public DrugUHIA ToDrugUHIA(string createdBy, string tenantId) => DrugUHIA.Create(null, ItemListId, EHealthCode, LocalDrugCode, InternationalNonProprietaryName,
