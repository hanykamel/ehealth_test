...
{
    public class BulkUploadDrugUhiaCreateCommandValidator : AbstractValidator<BulkUploadDrugsUhiaCreateCommand>
    {
        public BulkUploadDrugUhiaCreateCommandValidator()
        {
