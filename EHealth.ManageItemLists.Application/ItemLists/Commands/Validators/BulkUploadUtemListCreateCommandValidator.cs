...
{
    public class BulkUploadUtemListCreateCommandValidator : AbstractValidator<BulkUploadItemListCreateCommand>
    {
        public BulkUploadUtemListCreateCommandValidator()
        {
