...
namespace EHealth.ManageItemLists.DataAccess.Migrations
{
    ...
    [Migration("20231019094812_ChangeTableNameFromConsumablesAndDevicesToConsumablesAndDevicesUHIA")]
    partial class ChangeTableNameFromConsumablesAndDevicesToConsumablesAndDevicesUHIA
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EHealth.ManageItemLists.Domain.Consumables_Devices.ConsumablesAndDevicesUHIA", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("EHealth.ManageItemLists.Domain.ItemListPricing.ItemListPrice", b =>
                {
                    b.HasOne("EHealth.ManageItemLists.Domain.Consumables_Devices.ConsumablesAndDevicesUHIA", null)
                        .WithMany("ItemListPrices")
            ...
            modelBuilder.Entity("EHealth.ManageItemLists.Domain.Resource.ItemPrice.ResourceItemPrice", b =>
                {
                    ...
                    b.HasOne("EHealth.ManageItemLists.Domain.Resource.UHIA.ResourceUHIA", null)
                        .WithMany("ItemListPrices")
