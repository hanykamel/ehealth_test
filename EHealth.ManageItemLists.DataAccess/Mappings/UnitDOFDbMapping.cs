...
{
    public class UnitDOFDbMapping : IEntityTypeConfiguration<UnitDOF>
    {
        public void Configure(EntityTypeBuilder<UnitDOF> builder)
        {
            builder.ToTable("UnitsOfDoctorFees").HasKey(k => k.Id);
